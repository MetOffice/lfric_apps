...
|                            |                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|----------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| :repeat: CI                | [![Documentation](https://github.com/MetOffice/lfric_apps/actions/workflows/sphinx-docs.yaml/badge.svg)](https://github.com/MetOffice/lfric_apps/actions/workflows/sphinx-docs.yaml)                                                                                                                                                                                                                                                      |
