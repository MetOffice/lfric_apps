...
!> @brief Functions to compute a variety of analytic name field profiles.
...
!!          tracer fields for the name_transport miniapp.
module analytic_name_field_profiles_mod
...
function analytic_name_field(chi, choice, domain_max_x) result(tracer)
  ...
  case default
    write( log_scratch_space, '(A)' )  'Invalid test name choice, stopping'
    call log_event( log_scratch_space, LOG_LEVEL_ERROR )

  end select

end function analytic_name_field

end module analytic_name_field_profiles_mod
