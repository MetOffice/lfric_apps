...
:ref:`Multiple phases in the injection source` for the extention to multiple phases), we then
...
:ref:`Homogeneous forcing`) and (`[eq:deltaqc_exp2] <#eq:deltaqc_exp2>`__).
