...
\begin{figure}[tbh]
  \centering 
  \scalebox{0.46}{\includegraphics{wcrp_bltypes1}}
  \scalebox{0.46}{\includegraphics{wcrp_bltypes2}}
...
\begin{figure}[tb]
  \begin{center}
    \scalebox{1}{\includegraphics{ideal_invinteg}}
...
\begin{figure}[p]
  \centering
  \scalebox{0.8}{\includegraphics{stab_dep}}
...
\begin{figure}[tbh]
  ...
  \noindent\includegraphics[width=0.49\columnwidth]{zturb_schem.eps}
...
\begin{figure}[tbh]
  \centering
  \scalebox{1.0}{\includegraphics{subsent_fig7}}
...
\begin{figure}[tbh]
  \centering
  \scalebox{1.0}{\includegraphics{nbldoc_zidiag}}
...
\begin{figure}[p]
  \centering
  \scalebox{1}{\includegraphics{ideal_revflux}}
