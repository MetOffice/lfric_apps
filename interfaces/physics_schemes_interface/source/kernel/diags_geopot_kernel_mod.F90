...
!
MODULE diags_geopot_kernel_mod
  ...
  TYPE, EXTENDS(kernel_type) :: diags_geopot_kernel_type
    ...
    CONTAINS
      PROCEDURE, NOPASS :: code => diags_geopot_kernel_code
    END TYPE diags_geopot_kernel_type

CONTAINS

  SUBROUTINE diags_geopot_kernel_code(nlayers, &
             ! Output fields.
  ...
  END SUBROUTINE diags_geopot_kernel_code

END MODULE diags_geopot_kernel_mod
