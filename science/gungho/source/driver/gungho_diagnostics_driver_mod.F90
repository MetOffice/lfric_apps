...
module gungho_diagnostics_driver_mod
  ...
  use tropopause_diags_alg_mod,  only : tropopause_diags_alg
#endif
...
contains
  ...
  subroutine gungho_diagnostics_driver( modeldb,   &
    ...
    if (use_physics .and. use_xios_io .and. .not. modeldb%clock%is_initialisation()) then
      ...
      ! Tropopause height, temperature, pressure and ICAO height
      call tropopause_diags_alg(modeldb%config, theta, exner_in_wth)
#endif
