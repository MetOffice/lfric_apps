...
!!        with t = -Mt^(-1) * Pt2*u
module apply_split_mixed_operator_kernel_mod
...
use fs_continuity_mod, only : W2, W3, Wtheta, W2h, W2v, W2broken
...
type, public, extends(kernel_type) :: apply_u_mixed_operator_kernel_type
  ...
  contains
  procedure, nopass :: apply_u_mixed_operator_code
end type
type, public, extends(kernel_type) :: apply_w_mixed_operator_kernel_type
  private
  ...
  integer :: operates_on = CELL_COLUMN
  contains
  procedure, nopass :: apply_w_mixed_operator_code
end type
type, public, extends(kernel_type) :: apply_p_mixed_operator_kernel_type
  private
  ...
  integer :: operates_on = CELL_COLUMN
  contains
  procedure, nopass :: apply_p_mixed_operator_code
end type
type, public, extends(kernel_type) :: apply_wp_mixed_operator_kernel_type
  private
  ...
  integer :: operates_on = CELL_COLUMN
  contains
  procedure, nopass :: apply_wp_mixed_operator_code
end type

!-------------------------------------------------------------------------------
! Contained functions/subroutines
!-------------------------------------------------------------------------------
public :: apply_u_mixed_operator_code
public :: apply_w_mixed_operator_code
public :: apply_p_mixed_operator_code
public :: apply_wp_mixed_operator_code
...
subroutine apply_u_mixed_operator_code(cell,                       &
                                       nlayers,                    &
                                       lhs_uv,                     &
  ...
  integer(kind=i_def),                     intent(in) :: ncell1, ncell3
...
end subroutine apply_u_mixed_operator_code

subroutine apply_w_mixed_operator_code(cell,                       &
                                       nlayers,                    &
                                       lhs_w,                      &
                                       wind_uv, wind_w, exner,     &
                                       ncell0, pt2,                &
...
end subroutine apply_w_mixed_operator_code

subroutine apply_p_mixed_operator_code(cell,                       &
                                       nlayers,                    &
                                       lhs_p,                      &
                                       wind_uv, wind_w, exner,     &
                                       ncell0, pt2,                &
  ...
  ! Arguments
  integer(kind=i_def),                     intent(in) :: cell, nlayers
  integer(kind=i_def),                     intent(in) :: ncell0
...
end subroutine apply_p_mixed_operator_code

subroutine apply_wp_mixed_operator_code(cell,                       &
                                       nlayers,                    &
                                       lhs_w,                      &
                                       lhs_p,                      &
                                       wind_uv, wind_w, exner,     &
...
end subroutine apply_wp_mixed_operator_code

end module apply_split_mixed_operator_kernel_mod
