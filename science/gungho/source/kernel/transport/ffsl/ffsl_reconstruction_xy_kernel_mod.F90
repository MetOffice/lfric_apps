...
module ffsl_reconstruction_xy_kernel_mod
  ...
  type, public, extends(kernel_type) :: ffsl_reconstruction_xy_kernel_type
    private
  ...
  contains
    procedure, nopass :: ffsl_reconstruction_xy_code
  end type

  !-----------------------------------------------------------------------------
  ! Contained functions/subroutines
  !-----------------------------------------------------------------------------
  public :: ffsl_reconstruction_xy_code
  public :: ffsl_reconstruction_xy_1d
...
contains
  ...
  subroutine ffsl_reconstruction_xy_code( nlayers,             &
                                flux,                &
                                field_for_x,         &
                                stencil_sizes_x,     &
                                stencil_max_x,       &
    ...
    ! X direction --------------------------------------------------------------
    call ffsl_reconstruction_xy_1d( nlayers,             &
                          .true.,              &
                          flux,                &
                          field_for_x,         &
                          stencil_extent_xl,   &
  ...
  end subroutine ffsl_reconstruction_xy_code
...
! ============================================================================ !
  ...
  subroutine ffsl_reconstruction_xy_1d( nlayers,             &
                              x_direction,         &
                              flux,                &
                              field,               &
                              stencil_extent_l,    &
    ...
    do df_idx = 1, ABS(face_selector(map_w3_2d(1)))
      ...
      flux(w2h_idx : w2h_idx+nlayers-1) = recon_field(:)
    end do ! df_idx

  end subroutine ffsl_reconstruction_xy_1d

end module ffsl_reconstruction_xy_kernel_mod
