...
module fv_difference_x_kernel_mod
  ...
  !> Psy layer.
  !>
  type, public, extends(kernel_type) :: fv_difference_x_kernel_type
    private
  ...
  contains
    procedure, nopass :: fv_difference_x_code
  end type

  !---------------------------------------------------------------------------
  ! Contained functions/subroutines
  !---------------------------------------------------------------------------
  public :: fv_difference_x_code
...
contains
  ...
  subroutine fv_difference_x_code( nlayers,    &
                                   difference, &
                                   mass_flux,  &
                                   ndf_w3,     &
                                   undf_w3,    &
...
end module fv_difference_x_kernel_mod
