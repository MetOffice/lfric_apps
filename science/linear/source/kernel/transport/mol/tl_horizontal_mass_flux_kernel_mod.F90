...
!> @brief Kernel which computes tangent linear horizontal mass flux of a density by a wind
!!        field.
!!        The upwind direction is dictated by the linear wind
...
!!          mass flux is set, otherwise the value will be set by a neighbouring
!!          cell
module tl_horizontal_mass_flux_kernel_mod
...
type, public, extends(kernel_type) :: tl_horizontal_mass_flux_kernel_type
  private
...
contains
  procedure, nopass :: tl_horizontal_mass_flux_code
end type

!-------------------------------------------------------------------------------
! Contained functions/subroutines
!-------------------------------------------------------------------------------
public :: tl_horizontal_mass_flux_code
...
subroutine tl_horizontal_mass_flux_code( nlayers,        &
                                         mass_flux,      &
                                         ls_wind,        &
                                         wind,           &
                                         reconstruction, &
...
end subroutine tl_horizontal_mass_flux_code

end module tl_horizontal_mass_flux_kernel_mod
