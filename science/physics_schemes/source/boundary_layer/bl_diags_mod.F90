...
!$OMP SHARED(BL_diag,bl_levels,pdims)
  do k = 1, bl_levels
    do i = pdims%i_start,pdims%i_end
        BL_diag%rhogamu(i,k) = zero
    end do
  end do
!$OMP end PARALLEL do
else
  allocate(BL_diag%rhogamu(1,1))
end if
...
!$OMP SHARED(BL_diag,bl_levels,pdims)
  do k = 1, bl_levels
    do i = pdims%i_start,pdims%i_end
        BL_diag%rhogamv(i,k) = zero
    end do
  end do
!$OMP end PARALLEL do
else
  allocate(BL_diag%rhogamv(1,1))
end if
...
!$OMP SHARED(BL_diag,bl_levels,pdims)
  do k = 1, bl_levels
    do i = pdims%i_start,pdims%i_end
        BL_diag%rhogamt(i,k) = zero
    end do
  end do
!$OMP end PARALLEL do
else
  allocate(BL_diag%rhogamt(1,1))
end if
...
!$OMP SHARED(BL_diag,bl_levels,pdims)
  do k = 1, bl_levels
    do i = pdims%i_start,pdims%i_end
        BL_diag%rhogamq(i,k) = zero
    end do
  end do
!$OMP end PARALLEL do
else
  allocate(BL_diag%rhogamq(1,1))
end if
...
!$OMP SHARED(BL_diag,bl_levels,pdims)
  do k = 1, bl_levels
    do i = pdims%i_start,pdims%i_end
        BL_diag%elm(i,k) = zero
    end do
  end do
!$OMP end PARALLEL do
else
  allocate(BL_diag%elm(1,1))
end if
...
!$OMP SHARED(BL_diag,bl_levels,pdims)
  do k = 1, bl_levels
    do i = pdims%i_start,pdims%i_end
        BL_diag%tke_shr_prod(i,k) = zero
    end do
  end do
!$OMP end PARALLEL do
else
  allocate(BL_diag%tke_shr_prod(1,1))
end if
...
!$OMP SHARED(BL_diag,bl_levels,pdims)
  do k = 1, bl_levels
    do i = pdims%i_start,pdims%i_end
        BL_diag%tke_boy_prod(i,k) = zero
    end do
  end do
!$OMP end PARALLEL do
else
  allocate(BL_diag%tke_boy_prod(1,1))
end if
...
!$OMP SHARED(BL_diag,bl_levels,pdims)
  do k = 1, bl_levels
    do i = pdims%i_start,pdims%i_end
        BL_diag%tke_dissp(i,k) = zero
    end do
  end do
!$OMP end PARALLEL do
else
  allocate(BL_diag%tke_dissp(1,1))
end if
...
!$OMP SHARED(BL_diag,bl_levels,pdims)
  do k = 1, bl_levels
    do i = pdims%i_start,pdims%i_end
        BL_diag%wb_ng(i,k) = zero
    end do
  end do
!$OMP end PARALLEL do
else
  allocate(BL_diag%wb_ng(1,1))
end if
...
!$OMP SHARED(BL_diag,bl_levels,pdims)
  do k = 1, bl_levels
    do i = pdims%i_start,pdims%i_end
        BL_diag%cf_trb(i,k) = zero
    end do
  end do
!$OMP end PARALLEL do
else
  allocate(BL_diag%cf_trb(1,1))
end if
...
!$OMP SHARED(BL_diag,bl_levels,pdims)
  do k = 1, bl_levels
    do i = pdims%i_start,pdims%i_end
        BL_diag%ql_trb(i,k) = zero
    end do
  end do
!$OMP end PARALLEL do
else
  allocate(BL_diag%ql_trb(1,1))
end if
...
!$OMP SHARED(BL_diag,bl_levels,pdims)
  do k = 1, bl_levels
    do i = pdims%i_start,pdims%i_end
        BL_diag%sgm_trb(i,k) = zero
    end do
  end do
!$OMP end PARALLEL do
else
  allocate(BL_diag%sgm_trb(1,1))
end if
...
if (BL_diag%l_oblen) then
  ...
  allocate(BL_diag%oblen(1))
end if
if (BL_diag%l_ustar) then
  allocate(BL_diag%ustar(                                                      &
       pdims%i_start:pdims%i_end))
else
  allocate(BL_diag%ustar(1))
end if
if (BL_diag%l_wstar) then
  ...
  allocate(BL_diag%wstar(1))
end if
if (BL_diag%l_wbsurf) then
  allocate(BL_diag%wbsurf(                                                     &
       pdims%i_start:pdims%i_end))
else
  allocate(BL_diag%wbsurf(1))
end if
...
!$OMP SHARED(BL_diag,bl_levels,pdims)
  do k = 1, bl_levels
    do i = pdims%i_start,pdims%i_end
        BL_diag%dbdz(i,k) = zero
    end do
  end do
!$OMP end PARALLEL do
else
  allocate(BL_diag%dbdz(1,1))
end if
...
!$OMP SHARED(BL_diag,bl_levels,pdims)
  do k = 1, bl_levels
    do i = pdims%i_start,pdims%i_end
        BL_diag%rhokmsurf(i,k) = zero
    end do
  end do
!$OMP end PARALLEL do
else
  allocate(BL_diag%rhokmsurf(1,1))
end if
...
!$OMP SHARED(BL_diag,bl_levels,pdims)
  do k = 1, bl_levels
    do i = pdims%i_start,pdims%i_end
        BL_diag%rhokhsurf(i,k) = zero
    end do
  end do
!$OMP end PARALLEL do
else
  allocate(BL_diag%rhokhsurf(1,1))
end if
...
!$OMP SHARED(BL_diag,bl_levels,pdims)
  do k = 1, bl_levels
    do i = pdims%i_start,pdims%i_end
        BL_diag%rhokmsc(i,k) = zero
    end do
  end do
!$OMP end PARALLEL do
else
  allocate(BL_diag%rhokmsc(1,1))
end if
...
!$OMP SHARED(BL_diag,bl_levels,pdims)
  do k = 1, bl_levels
    do i = pdims%i_start,pdims%i_end
        BL_diag%rhokhsc(i,k) = zero
    end do
  end do
!$OMP end PARALLEL do
else
  allocate(BL_diag%rhokhsc(1,1))
end if
...
!$OMP SHARED(BL_diag,bl_levels,pdims)
  do k = 1, bl_levels
    do i = pdims%i_start,pdims%i_end
        BL_diag%dissip(i,k) = zero
    end do
  end do
!$OMP end PARALLEL do
else
  allocate(BL_diag%dissip(1,1))
end if
...
!$OMP SHARED(BL_diag,bl_levels,pdims)
  do k = 1, bl_levels
    do i = pdims%i_start,pdims%i_end
        BL_diag%slvar(i,k) = zero
    end do
  end do
!$OMP end PARALLEL do
else
  allocate(BL_diag%slvar(1,1))
end if
...
!$OMP SHARED(BL_diag,bl_levels,pdims)
  do k = 1, bl_levels
    do i = pdims%i_start,pdims%i_end
        BL_diag%qwvar(i,k) = zero
    end do
  end do
!$OMP end PARALLEL do
else
  allocate(BL_diag%qwvar(1,1))
end if
...
!$OMP SHARED(BL_diag,bl_levels,pdims)
  do k = 1, bl_levels
    do i = pdims%i_start,pdims%i_end
        BL_diag%grad_ftl(i,k) = zero
    end do
  end do
!$OMP end PARALLEL do
else
  allocate(BL_diag%grad_ftl(1,1))
end if
...
!$OMP SHARED(BL_diag,bl_levels,pdims)
  do k = 1, bl_levels
    do i = pdims%i_start,pdims%i_end
        BL_diag%non_grad_ftl(i,k) = zero
    end do
  end do
!$OMP end PARALLEL do
else
  allocate(BL_diag%non_grad_ftl(1,1))
end if
...
!$OMP SHARED(BL_diag,bl_levels,pdims)
  do k = 1, bl_levels
    do i = pdims%i_start,pdims%i_end
        BL_diag%ftl_e(i,k) = zero
    end do
  end do
!$OMP end PARALLEL do
else
  allocate(BL_diag%ftl_e(1,1))
end if
...
!$OMP SHARED(BL_diag,bl_levels,pdims)
  do k = 1, bl_levels
    do i = pdims%i_start,pdims%i_end
        BL_diag%rhokhz_ex(i,k) = zero
    end do
  end do
!$OMP end PARALLEL do
else
  allocate(BL_diag%rhokhz_ex(1,1))
end if
...
!$OMP SHARED(BL_diag,bl_levels,pdims)
  do k = 1, bl_levels
    do i = pdims%i_start,pdims%i_end
        BL_diag%dTfric(i,k) = zero
    end do
  end do
!$OMP end PARALLEL do
else
  allocate(BL_diag%dTfric(1,1))
end if
